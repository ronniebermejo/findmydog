...
Pet.create(name: 'Chana',comments: 'Soy una perrita criolla que me perdi en los sembradios cerca de la secundaria numero 8, por favor llamar al 2 16 61 38', owner: ronnie, image_id: image2.id, place_id: casa_montenegro.id )
Pet.create(name: 'Mugus',comments: 'Perro Yorki extraviado en la colonia tejada, responde al nombre de mugus, muguñe, enano, ven aca',owner: ronnie, image_id: image4.id, place_id: casa_tejeda.id )
Pet.create(name: 'Monga',comments: 'POR FAFOR AYUDANOS ENCONTRAR A NUESTA PERRITA SE PERDIO EL DOMINGO 13 DE JULIO EN EL CENTRO DE QUERETARO TRAIA UN SUETER AZUL Y COLLAR CAFÉ, ALGUNAS PERSONAS LA VIERON CORRIENDO POR LA CALLE 5 DE MAYO.', owner: gaby, image_id: image5.id, place_id: qro2000.id )
...
Pet.create(name: 'Lincy',comments: 'Bella", tiene 4 años, de 40 cm aprox. Se perdio el 12 de Julio en Hacienda la Gloria', owner: gaby, image_id: image7.id, place_id: estadio.id )
...
Pet.create(name: 'Timmy',comments: 'Mi nombre es TIMMY, estoy perdido y necesito regresar a mi hogar. Si me ves por favor llama al Tel 313 1613', owner: gaby, image_id: image10.id, place_id: casa_tejeda.id )
Pet.create(name: 'Laika',comments: 'Hola! Encontré hoy 01/07/14 a éste perro en Campestre Jurica. Parece cruza de Labrador con Rottweiler. No trae placa ni collar pero se ve muy bien cuidado. Esta esperando a su familia.', owner: gaby, image_id: image2.id, place_id: plaza_sendero.id )
Pet.create(name: 'Puchis',comments: 'HOLA, POR FAVOR AYUDANOS A ENCONTRAR A POLET, ES UNA PERRITA SCHNAUZER, TIENE 3 AÑOS. SE PERDIO EN LA CALLE DE PRIMAVERA EL 15 DE JULIO DEL PRESENTE.', owner: gaby, image_id: image3.id, place_id: centro.id )
Pet.create(name: 'GYPSY',comments: 'Por favor ayúdame a regresar a mi casa, me perdí el día 2 de Junio por la noche en la colonia San Pedrito Peñuelas. Mi hermanita humana me necesita tiene asma.', owner: gaby, image_id: image3.id, place_id: penuelas.id )
